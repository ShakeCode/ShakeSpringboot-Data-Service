...
/**
 * The type Multiple ds configuration.
 */
@Component
@ConfigurationProperties(prefix = "spring.datasource")
@Data
public class MultipleDSConfig {
    ...
    /**
     * Build data source druid data source.
     * @param druidDataSource the druid data source
     * @return the druid data source
     */
    public DruidDataSource buildDataSource(DruidDataSource druidDataSource) {
        // 初始连接数
